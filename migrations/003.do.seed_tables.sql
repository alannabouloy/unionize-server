...
VALUES
    ...
    ('American Train Dispatchers Association', 3, 'The ATDA represents employees in the United States'' railroad industry in charge of dispatching trains and suplying electric power for railroads to be used in train propulsion and signalling.', 'http://www.atda.org/'),
    ...
    ('International Union of Allied, Novelty and Production Workers', 17, 'This union covers workers employed in eneral manufacturing and related industries.', 'http://iuanpw.org/'),
    ('International Union of Bricklayers and Allied Craftworkers', 12, 'BAC represents the most highly skilled trowel trades craftworkers across the United States and Canada, including brickllayers, stone and marble masons, cement masons, plasterers, tilesetters, terrazzon and mosaic workers, and pointers/cleaners/caulkers.', 'http://www.bacweb.org/'),
    ...
    ('United Automobile, Aerospace & Agricultural Implement Workers of America International Union', 17, 'UAW-represented workplaces range from multinational corporation, small manufacturers and state and local governments, to colleges and universities, hospitals and private non-profit orgainizations.', 'http://www.uaw.org/'),
    ...
    ('United Mine Workers of America', 18, 'The UMWA serves a diverse community of coal miners, manuacturing workers, clean coal technicians, health care workers and more throughout the US and Canada.', 'http://www.umwa.org/'),
